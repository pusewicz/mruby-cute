module Cute
  ...
  # @return [nil]
  def self.cf_draw_text(text, position, num_chars_to_draw = -1); end
  ...
  def self.cf_text_width(text, num_chars_to_draw = -1); end
  ...
  def self.cf_text_height(text, num_chars_to_draw = -1); end
  ...
  def self.cf_text_size(text, num_chars_to_draw = -1); end
end