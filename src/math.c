...
{
  // CF_V2
  struct RClass* v2_class = mrb_define_class_under(mrb, mrb_cute_module, "V2", mrb->object_class);
  ...
  // cute_math
  mrb_define_module_function(mrb, mrb_cute_module, "V2", mrb_cf_v2, MRB_ARGS_REQ(2));
}
